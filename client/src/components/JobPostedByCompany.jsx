...
const JobPostedByCompany = () => {
	...
	useEffect(() => {
		const alljobs = async () => {
			const response = await fetch(
				`https://student-hiring-app-five.vercel.app:4000/company/all_job_posted/${user._id}`,
				{
					method: "GET",
		...
		const userInfoMethod = async () => {
			if (user.userType == "student") {
				const response = await fetch(`https://student-hiring-app-five.vercel.app:4000/user/${user._id}`, {
					method: "GET",
					headers: { "Content-Type": "application/json" },
				});
				if (response.status == 200) {
				...
				const response = await fetch(
					`https://student-hiring-app-five.vercel.app:4000/company/getCompany/${user._id}`,
					{
						method: "GET",
						headers: { "Content-Type": "application/json" },
					}
	...
	const handleApplyJob = async (jobId) => {
		...
		const response = await fetch("https://student-hiring-app-five.vercel.app:4000/user/apply_for_job", {
			method: "PUT",
			headers: { "Content-Type": "application/json" },
	...
	const handleSaveJob = async (jobId) => {
		...
		const response = await fetch("https://student-hiring-app-five.vercel.app:4000/user/save_job", {
			method: "PUT",
			headers: { "Content-Type": "application/json" },
			body: JSON.stringify(body),
		});
