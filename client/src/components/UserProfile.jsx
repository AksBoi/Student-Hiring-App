...
const UserProfile = () => {
	...
	const handleSubmit = async () => {
		...
		if (pdffile) {
			...
			const response = await fetch("https://student-hiring-app-five.vercel.app:4000/upload/upload_pdf", {
				method: "POST",
				body: formData,
			});
		...
		const response = await fetch(
			`https://student-hiring-app-five.vercel.app:4000/user/updateProfile/${user._id}`,
			{
				method: "PUT",
				headers: { "Content-Type": "application/json" },
