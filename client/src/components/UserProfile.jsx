...
const UserProfile = () => {
	...
	const handleSubmit = async () => {
		...
		if (pdffile) {
			...
			const response = await fetch("https://student-hiring-app-3.onrender.com/upload/upload_pdf", {
				method: "POST",
				body: formData,
			});
		...
		const response = await fetch(
			`https://student-hiring-app-3.onrender.com/user/updateProfile/${user._id}`,
			{
				method: "PUT",
				headers: { "Content-Type": "application/json" },
